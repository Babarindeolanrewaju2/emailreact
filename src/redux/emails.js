let initialState = {
    mails: [
      {
        ...
        to: ["johndoe@mail.com"],
        img: "http://www.realpeopleproject.com/wp-content/uploads/2015/08/jaumereal.jpg",
      ...
      },
      {
        ...
        to: ["johndoe@mail.com"],
        img: "http://www.realpeopleproject.com/wp-content/uploads/2015/08/aidareal.jpg",
      ...
      },
      {
        ...
        to: ["johndoe@mail.com"],
        img:"http://www.realpeopleproject.com/wp-content/uploads/2015/08/paureal.jpg",
        ...
        replies: [
          {
            ...
            to: ["hettiem@mail.com"],
            img: "http://www.realpeopleproject.com/wp-content/uploads/2015/08/annreal.jpg",
            subject: "",
            cc: [],
            bcc: [],
          ...
          },
          {
            ...
            sender_name: "Hettie Mcerlean",
            to: ["johndoe@mail.com"],
            img: "http://www.realpeopleproject.com/wp-content/uploads/2015/08/jingreal.jpg",
            subject: "",
            cc: [],
            bcc: [],
      ...
      },
      {
        ...
        to: ["johndoe@mail.com"],
        img: "http://www.realpeopleproject.com/wp-content/uploads/2015/08/lilyreal.jpg",
        subject: "Ui Related",
        cc: [],
        bcc: [],
      ...
      },
      {
        ...
        to: ["johndoe@dot.gov"],
        img: "http://www.realpeopleproject.com/wp-content/uploads/2015/08/jesusreal.jpg",
      ...
      },
      {
        ...
        img: "http://www.realpeopleproject.com/wp-content/uploads/2015/08/dirkreal.jpg",
      ...
      },
      {
        ...
        img: "http://www.realpeopleproject.com/wp-content/uploads/2015/08/ricartreal.jpg",
      ...
      },
      {
        ...
        img: "http://www.realpeopleproject.com/wp-content/uploads/2015/08/alfredreal.jpg",
      ...
      },
      {
        ...
        img: "http://www.realpeopleproject.com/wp-content/uploads/2015/08/jakereal.jpg",
      ...
      },
      {
        ...
        img: "http://www.realpeopleproject.com/wp-content/uploads/2015/07/jorgereal.jpg",
      ...
      },
      {
        ...
        to: ["johndoe@fda.gov"],
        img: "http://www.realpeopleproject.com/wp-content/uploads/2015/10/santiimpreal.jpg",
      ...
      },
      {
        ...
        img: "http://www.realpeopleproject.com/wp-content/uploads/2015/08/santireal.jpg",
      ...
      },
      {
        ...
        img: "http://www.realpeopleproject.com/wp-content/uploads/2015/07/llorencreal.jpg",
      ...
      },
      {
        ...
        sender_name: "Eb Begg",
        to: ["johndoe@51.la"],
        img: "http://www.realpeopleproject.com/wp-content/uploads/2015/07/mariareal.jpg",
      ...
      },
      {
        ...
        img: "http://www.realpeopleproject.com/wp-content/uploads/2015/06/toshireal.jpg",
      ...
      },
      {
        ...
        img: "http://www.realpeopleproject.com/wp-content/uploads/2015/06/ichikareal.jpg",
      ...
      },
      {
        ...
        to: ["johndoe@si.edu"],
        img: "http://www.realpeopleproject.com/wp-content/uploads/2015/06/chitareal.jpg",
      ...
      },
      {
        ...
        img: "http://www.realpeopleproject.com/wp-content/uploads/2015/06/urireal.jpg",
      ...
      },
      {
        ...
        img: "http://www.realpeopleproject.com/wp-content/uploads/2015/06/tonireal.jpg",
      ...
      },
      {
        ...
        to: ["johndoe@ow.ly"],
        img: "http://www.realpeopleproject.com/wp-content/uploads/2015/06/ryokoreal.jpg",
      ...
      },
      {
        ...
        to: ["johndoe@furl.net"],
        img: "http://www.realpeopleproject.com/wp-content/uploads/2015/06/koujireal.jpg",
      ...
      },
      {
        ...
        to: ["johndoe@cnet.com"],
        img: "http://www.realpeopleproject.com/wp-content/uploads/2015/06/hideyukireal.jpg",
      ...
      },
      {
        ...
        img: "http://www.realpeopleproject.com/wp-content/uploads/2015/06/katohreal.jpg",
  ...
  const emails = (state = initialState, action) => {
    switch (action.type) {
      case "GET_MAILS":
        let filteredMail = [...state.mails]
        // mails = action.mails
        return { ...state, filteredMails: filteredMail }
  
      case "SET_STARRED":
      console.log(action.payload)
        state.mails.find(
          i => i.id === action.payload
        ).isStarred = !state.mails.find(i => i.id === action.payload).isStarred
        return { ...state }
      ...
      case "SEARCH_MAIL":
        let filteredMails = state.mails.filter(val => {
          if (action.payload.length > 0) {
            return (
              val.sender_name.toLowerCase().includes(action.payload) ||
              val.sender.toLowerCase().includes(action.payload) ||
              val.message.includes(action.payload) ||
              val.subject.toLowerCase().includes(action.payload)
            )
          } else {
            return state.mails
          }
      ...
      case "DELETE_MAIL":
        console.log(action)
        let mails = []
        let selectedEmail = [...state.selectedEmails]
        console.log(state.selectedEmail)
      
        mails = state.filteredMails.filter(id => !selectedEmail.includes(id.id))
        // console.log(state.selectedEmails.length = 0)
        console.log(state)
        return { ...state, selectedEmails: [] ,filteredMails:mails}
      ...
      case "FILTER_MAIL_FOLDER":
        let mailFolder = state.mails.filter(id => id.mailFolder === action.payload)
        return {
          ...state,
          filteredMails: mailFolder
        }
      case "MOVE_MAIL":
        return { ...state, selectedEmails: [] }
      case "SET_UNREAD":
